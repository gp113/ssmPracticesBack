        ...
        <div style="width: 400px; height: 290px; margin: auto auto; background: #ffffff; text-align: center; margin-top: -200px; border: 1px solid #e7e7e7">
            ...
            <form action="<%=basePath%>/login.do" method="post">
                ...
                <p style="padding: 30px 0px 10px 0px; position: relative;">
                    <span class="u_logo"></span> <input class="ipt acc" type="text" name="account" id="account" placeholder="请输3-12位入用户名" pattern=".{3,12}">
                </p>
                <p style="position: relative;">
                    <span class="p_logo"></span> <input id="password" class="ipt" type="password" name="password" placeholder="请输入密码" pattern=".{3,6}">
                </p>
