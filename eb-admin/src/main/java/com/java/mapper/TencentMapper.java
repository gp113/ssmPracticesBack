...
public interface TencentMapper {
     ...
     * @return
     */
    List<Map<String, Object>> list(TencentCloudServer tencentCloudServer);
     ...
     * @return
     */
    int saveCloudData(TencentCloudServer tencentCloudServer);
     ...
     * @return
     */
    int updateCloudData(TencentCloudServer tencentCloudServer);
}
