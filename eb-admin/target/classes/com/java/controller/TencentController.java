...
public class TencentController {
    ...
    @ResponseBody
    public Map<String, Object> list(TencentCloudServer tencentCloudServer,
                                    @RequestParam(value = "pageNum", required = false, defaultValue = "1") int pageNum,
                                    @RequestParam(value = "pageSize", required = false, defaultValue = "99999") int pageSize) {
        return tencentService.list(tencentCloudServer, pageNum, pageSize);
    }
    ...
    public List<Map<String, Object>> getTypeList() {
        return tencentService.getTypeList();
    }
     ...
     * @return
     */
    @RequestMapping("/getHangYeTypeList.do")
    @ResponseBody
    public List<Map<String, Object>> getHangYeTypeList() {
        return tencentService.getHangYeTypeList();
    }
     ...
     * @return
     */
    @RequestMapping("/saveCloudData.do")
    @ResponseBody
    public boolean saveCloudData(TencentCloudServer tencentCloudServer) {
        return tencentService.saveCloudData(tencentCloudServer);
    }
     ...
     * @return
     */
    @RequestMapping("/deleteCloudData.do")
    @ResponseBody
    public boolean deleteCloudData(@RequestParam(value = "idStr") String idStr) {
        return tencentService.deleteCloud(idStr);
    }
}
